							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img src="img/woo1.jpg" alt=" "/></a>
									</div>
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									...
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="womens.html"><img src="img/woo.jpg" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
				...
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="images/d2.jpg">
							<div class="thumb-image"> <img src="img/d2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="images/d1.jpg">
							<div class="thumb-image"> <img src="img/d1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<li data-thumb="images/d3.jpg">
							<div class="thumb-image"> <img src="img/d3.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="images/d4.jpg">
							<div class="thumb-image"> <img src="img/d4.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
					</ul>
					<div class="clearfix"></div>
				</div>	
...
<div class="footer">
	<div class="container">
		<div class="col-md-3 footer-left">
			<h2><a href="index.html"><img src="img/logo3.jpg" alt=" " /></a></h2>
			<p>Neque porro quisquam est, qui dolorem ipsum quia dolor
		...
		<div class="col-md-9 footer-right">
			...
			<div class="sign-grds">
				...
				<div class="col-md-4 sign-gd flickr-post">
					<h4>Flickr Posts</h4>
					<ul>
						<li><a href="single.html"><img src="img/b15.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="img/b16.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="img/b17.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="img/b18.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="img/b15.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="img/b16.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="img/b17.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="img/b18.jpg" alt=" " class="img-responsive" /></a></li>
